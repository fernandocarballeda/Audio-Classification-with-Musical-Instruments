...
def train(args):
    ...
    csv_path = os.path.join('logs_folder', '{}_history.csv'.format(model_type))
    ...
    cp = ModelCheckpoint('models_folder/{}.h5'.format(model_type), monitor='val_loss',
...
if __name__ == '__main__':
    ...
    parser.add_argument('--src_root', type=str, default='clean_folder',
